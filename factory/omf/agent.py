...
_ACTIONS: tuple[ActionDefinition, ...] = (
    ...
    ActionDefinition(
        "module.test",
        "Execute module conformance fixtures in the local isolation boundary.",
...
_ACTIONS += (
    ...
    ActionDefinition(
        "conformance.build",
        "Build, sign, and commit a conservative conformance report from measured evidence.",
        "omf conformance build <evidence> --output <path>",
        "POST",
        "/v1/conformance/reports",
        "write",
        True,
        False,
        "report-content-idempotent-events-repeat",
        "medium",
        "io",
        ("evidence.readable", "required-measurements.present"),
        ("Signed conformance report and immutable artifact committed.",),
        approval_required=True,
    ),
    ActionDefinition(
        "conformance.verify",
        "Verify a signed conformance report and its fail-closed profile claims.",
        "omf conformance verify <report>",
        "POST",
        "/v1/conformance/verify",
        "write",
        False,
        False,
        "read-only",
